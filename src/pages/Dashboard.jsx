        ...
        {/* <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <p className="text-sm font-medium text-gray-900">Kelola Materi</p>
            </button>
            ...
            {isAdmin && (
              <button 
                ...
                className="p-4 bg-accent-50 rounded-lg hover:bg-accent-100 transition-colors text-left"
              >
            ...
            {isAdmin && (
              ...
              >
                ...
                <p className="text-sm font-medium text-gray-900">Riwayat Chat</p>
              </button>
            )}
          </div>
        </div> */}
